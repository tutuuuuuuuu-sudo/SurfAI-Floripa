...
export const PLAN_FEATURES = [
  { label: 'Nota de IA em tempo real', free: true, premium: true },
  ...
  { label: 'Diário de surf', free: true, premium: true },
...
export const FAQS = [
  ...
  { q: 'O plano gratuito tem alguma limitação?', a: 'No plano gratuito você tem acesso à nota de IA em tempo real, previsão para os próximos 3 dias, favoritos, diário de surf e navegação até a praia. Para previsão de 14 dias, alertas push, histórico completo e comparação de praias, é necessário o Premium.' },
