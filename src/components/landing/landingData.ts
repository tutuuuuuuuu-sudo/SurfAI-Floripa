...
export const MOCK_SPOTS = [
  { beach: 'Praia Mole', score: 9.1, wave: '1.2m', wind: '12km/h', period: '13s', color: 'var(--color-rating-epic)', colorAlpha: (a: number) => `color-mix(in srgb, var(--color-rating-epic) ${a}%, transparent)`, label: 'ÉPICO' },
  { beach: 'Joaquina', score: 7.8, wave: '1.0m', wind: '15km/h', period: '11s', color: 'var(--color-rating-excellent)', colorAlpha: (a: number) => `color-mix(in srgb, var(--color-rating-excellent) ${a}%, transparent)`, label: 'EXCELENTE' },
  { beach: 'Campeche', score: 6.5, wave: '0.8m', wind: '18km/h', period: '10s', color: 'var(--color-rating-good)', colorAlpha: (a: number) => `color-mix(in srgb, var(--color-rating-good) ${a}%, transparent)`, label: 'BOM' },
  { beach: 'Santinho', score: 4.2, wave: '0.6m', wind: '25km/h', period: '7s', color: 'var(--color-rating-fair)', colorAlpha: (a: number) => `color-mix(in srgb, var(--color-rating-fair) ${a}%, transparent)`, label: 'REGULAR' },
]
